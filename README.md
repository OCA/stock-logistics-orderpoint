...
--- | --- | --- | ---
[sale_stock_orderpoint_mto_as_mts](sale_stock_orderpoint_mto_as_mts/) | 16.0.1.0.0 |  | Ensure orderpoint when so line route is mto
[stock_location_orderpoint](stock_location_orderpoint/) | 16.0.2.0.2 | <a href='https://github.com/mt-software-de'><img src='https://github.com/mt-software-de.png' width='32' height='32' style='border-radius:50%;' alt='mt-software-de'/></a> | Declare orderpoint on a location allowing to replenish any product with the same criteria.
...
[stock_orderpoint_mto_as_mts](stock_orderpoint_mto_as_mts/) | 16.0.1.3.0 |  | Materialize need from MTO route through orderpoint
