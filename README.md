...
[stock_location_orderpoint](stock_location_orderpoint/) | 16.0.2.0.3 | <a href='https://github.com/mt-software-de'><img src='https://github.com/mt-software-de.png' width='32' height='32' style='border-radius:50%;' alt='mt-software-de'/></a> | Declare orderpoint on a location allowing to replenish any product with the same criteria.
