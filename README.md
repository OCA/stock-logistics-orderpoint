...
--- | --- | --- | ---
[stock_location_orderpoint](stock_location_orderpoint/) | 16.0.1.0.0 | [![mt-software-de](https://github.com/mt-software-de.png?size=30px)](https://github.com/mt-software-de) | Declare orderpoint on a location allowing to replenish any product with the same criteria.
