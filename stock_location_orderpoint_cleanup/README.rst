...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:f911774caa6722d9626c3ffddba43fdb01888bbbc48577ab3dbc0f4fa78f7159
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
- You can configure crons to execute cleanup actions.
  ...
  - Add a cron with:
    ...
    - In python code, add a line 'model.run_cleanup(orderpoints,
      ...
      cleanup.
    - If you want to cleanup ordepoints by replenish method, add a line
      'model.run_cleanup_method(replenish_method, run_after)' where
      'replenish_method' is 'fill_up' by default (depending on extension
