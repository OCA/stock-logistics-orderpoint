...
setuptools.setup(
    ...
    version=version,
    install_requires=[
        'odoo-addon-sale_stock_orderpoint_mto_as_mts>=16.0dev,<16.1dev',
        'odoo-addon-stock_location_orderpoint>=16.0dev,<16.1dev',
        'odoo-addon-stock_location_orderpoint_average_daily_sale>=16.0dev,<16.1dev',
        ...
        'odoo-addon-stock_orderpoint_no_horizon>=16.0dev,<16.1dev',
        'odoo-addon-stock_orderpoint_origin>=16.0dev,<16.1dev',
        'odoo-addon-stock_orderpoint_origin_mrp_link>=16.0dev,<16.1dev',
